...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		//3D new plants
		bucephalandra = plantRegistryHelper(new BlockPlantLilyPad3dFlower().setName(AthsGlobal.BUCEPHALANDRA).setPart("Base").setPart("Overlay").setIsConstantSize().setScale(1.0f)); //Model Changed
		...
		victoriaLilyPad = plantRegistryHelper(new BlockPlantLilyPad3d().setOvercrowdRadius(1).setName(AthsGlobal.VICTORIA_LILY_PAD).setParts(new String[] {"Base", "Rim_Gap", "Rim_Middle", "Roots"}).setScale(2.0f).setHasCollision()); //model changed
		...
		mayapple = plantRegistryHelper(new BlockPlant3dFlower().setName(AthsGlobal.MAYAPPLE).addVarys(new EnumVary[] {EnumVary.AUTUMN, EnumVary.WINTER, EnumVary.FLOWER, EnumVary.SNOW}).setNamedPart("Side").setVaryParts(new EnumVary[] {EnumVary.DEFAULT, EnumVary.FLOWER}, new String[] {"Top", "Underlay"}).setNamedVaryPart(EnumVary.AUTUMN, "Top").setNamedVaryPart(EnumVary.AUTUMN, "Underlay").setFlowerMonthRange(TFC_Time.JUNE, TFC_Time.OCTOBER).setScale(1.3f));//model changed
		plantainWeed = plantRegistryHelper(new BlockPlant3dFlower().setName(AthsGlobal.PLANTAIN_WEED).addVary(EnumVary.FLOWER).setNamedPart("Side").setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.FLOWER}, "Leaf").setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.FLOWER}, "Leaf_Overlay").setFlowerMonthRange(TFC_Time.APRIL, TFC_Time.OCTOBER).setScale(0.8f));//model changed
		...
		dumbCane = plantRegistryHelper(new BlockPlant3d().setExtraNames(AthsGlobal.DUMB_CANE, "Variegated").setPart("Stem").setNamedPart("Leaf").setOverrideModelName().setScale(2.0f));//model changed
		...
		diamondleafFern = plantRegistryHelper(new BlockPlantTree3d().setName(AthsGlobal.DIAMONDLEAF_FERN).setPart("Frond").setPart("Stem").setIsAxisAligned().setScale(2.5f));//model changed
		...
		bristleFern = plantRegistryHelper(new BlockPlant3d().setName(AthsGlobal.BRISTLE_FERN).setPart("Frond").setScale(2.0f)); //Model changed
